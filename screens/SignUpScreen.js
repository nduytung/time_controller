    ...
    return(
        <View style={signupStyle.container}>
            ...
            style={signupStyle.footer}>
                ...
                <Text style={[signupStyle.text_footer, {marginTop: 10}]}>Email address</Text>
                <View style={signupStyle.action}>
                    <FontAwesome
                        name="user-o"
                        color="#05375a"
                ...
                <Text style={[signupStyle.text_footer,{marginTop:10}]}>Confirm Password</Text>
                <View style={signupStyle.action}>
                    <FontAwesome
                        name="lock"
                        color="#05375a"
                ...
                <View style={signupStyle.button}>
                    ...
                    style={[signupStyle.SignIn,{
                        ...
                        <LinearGradient
                            ...
                            style={signupStyle.SignIn}>
                                <Text style={[signupStyle.textSign,{color:'white'}]}>Sign Up</Text>
                        </LinearGradient>
                    </TouchableOpacity>
