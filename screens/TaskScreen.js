        ...
        <ScrollView style={{margin: 10}}>
            ...
            <View style={taskStyle.box1}>
                <View style={taskStyle.information}>
                    ...
                    <View style={taskStyle.rightInformation}>
                        <TextTicker style={taskStyle.rightInfor1}>Thiết kế mạng </TextTicker>
                        <Text style={taskStyle.rightInfor2}>27.11.2021</Text>
                        <TextTicker style={taskStyle.rightInfor3}>Deadline kỳ này quá căng nên cần phải làm sớm thuiii</TextTicker>
            ...
            <View style={taskStyle.box2}>
                <View style={taskStyle.information}>
                    ...
                    <View style={taskStyle.rightInformation}>
                        <TextTicker style={taskStyle.rightInfor1}>An toàn mạng máy tính </TextTicker>
                        <Text style={taskStyle.rightInfor2}>27.11.2021</Text>
            ...
            <View style={taskStyle.box1}>
                <View style={taskStyle.information}>
                    ...
                    <View style={taskStyle.rightInformation}>
                        ...
                        <Text style={taskStyle.rightInfor2}>27.11.2021</Text>
                        <TextTicker style={taskStyle.rightInfor3}>Thực hành code với react native</TextTicker>
                        <TouchableOpacity style={taskStyle.touchFix} onPress={() => {}}>
                            <Text style={taskStyle.textFix}>Sửa</Text>
                        </TouchableOpacity>
                    </View>
